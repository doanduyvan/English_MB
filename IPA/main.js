...
function hanldClick(e){
    ...
    let id = box.querySelector('span').innerText;
    id = parseInt(id);
    if(id == idCurent){
        audio.pause();
        audio.play();
